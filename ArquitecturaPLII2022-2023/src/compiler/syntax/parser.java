...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 19 12:18:52 GMT 2023
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		int lIDsleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int lIDsright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		ListadoIDs lIDs = (ListadoIDs)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int scleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int scright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Token sc = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
							...
							for(Id id : lIDs.getListaIds()){
								...
								TemporalIF temp = tf.create();
								Variable var = new Variable(id.getName(), scope);
		...
		DeclaracionVariable dec = (DeclaracionVariable)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		DeclaracionVariable dec = (DeclaracionVariable)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						ScopeIF scope = scopeManager.getCurrentScope();
				   		...
				   		cb.addQuadruples(sV.getIntermediateCode());  //anadir el codigo de las variables ya generadas
				   		cb.addQuadruples(dec.getIntermediateCode());       //anadir el codigo de la nueva variable
		...
		Object ax = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
  		...
  		String cuadruplas = "";
		List<QuadrupleIF> intermediateCode = ((Axiom2)ax).getIntermediateCode();
