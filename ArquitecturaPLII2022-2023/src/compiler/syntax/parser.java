...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 13 08:13:32 GMT 2023
  */
      ...
      switch (CUP$parser$act_num)
		...
		CuerpoFuncion cFunc = (CuerpoFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
				...
				if(cFunc.getListadoSentencias().getDevuelve()){
					semanticErrorManager.semanticFatalError("Error: La funcion de tipo vacio '" +id.getLexema()+"' no debe devolver una expresiÛn");
				}
		...
		CuerpoFuncion cFunc = (CuerpoFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
				...
				if(!cFunc.getListadoSentencias().getDevuelve() ||
				   !(cFunc.getListadoSentencias().getTipoDevuelto() instanceof TypeSimpleEntero)){
					semanticErrorManager.semanticFatalError("Error: La funcion de tipo entero '" +id.getLexema()+"' debe devolver una expresiÛn de tipo entero");
				}
