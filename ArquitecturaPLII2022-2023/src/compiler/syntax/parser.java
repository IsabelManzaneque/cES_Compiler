...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 19 10:21:08 GMT 2023
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		DeclaracionParametros dP = (DeclaracionParametros)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				//		   		TemporalIF temp = param.getTemporal();
						   		cb.addQuadruples(dP.getIntermediateCode());    // anadir el codigo de los parametros ya generados
						   		cb.addQuadruples(param.getIntermediateCode()); // anadir el codigo del nuevo parametro
				//		   		cb.addQuadruple("PARAM",temp);                 // anadir el nuevo parametro
		...
		ListadoSentencias lS = (ListadoSentencias)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				//	cb.addQuadruples(sT.getIntermediateCode());
				//	cb.addQuadruples(sV.getIntermediateCode());
					cb.addQuadruples(lS.getIntermediateCode());
		...
		int cFunleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int cFunright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		CuerpoFuncion cFun = (CuerpoFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		...
		CuerpoFuncion cFun = (CuerpoFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
				...
				if(!cFun.getListadoSentencias().getDevuelve() ||
				   !(cFun.getListadoSentencias().getTipoDevuelto() instanceof TypeSimpleEntero)){
