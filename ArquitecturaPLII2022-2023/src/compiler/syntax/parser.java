...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Mar 13 18:40:36 GMT 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Expresion expr = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
                 	...
                 	if(expr.getValue() < 0 || expr.getValue() > typeArray.getSize() -1){
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				if(symbol instanceof SymbolConstant){
					exp.setValue(((SymbolConstant)symbol).getValue());
				}
				if(symbol instanceof SymbolVariable){
					exp.setValue(((SymbolVariable)symbol).getValue());
				}
