...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Apr 25 13:29:19 BST 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				int result = 0;
				if(e1.getValue() == 1 && e2.getValue() == 1){result = 1;}				
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				int result = e1.getValue() == e2.getValue() ? 1 : 0;
				exp.setType(e1.getType());
				exp.setValue(result);
