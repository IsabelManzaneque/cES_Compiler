...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 19 08:52:52 GMT 2023
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Sentencia sent = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                    	...
                    	if(sent instanceof SentenciaDevuelve){
							...
							if(sentDevuelve.getExpresion() != null){
								lS.setDevuelve(true);
								lS.setTipoDevuelto(sentDevuelve.getExpresion().getType());
							}
						}												
                    	lS.add(sent);
		...
		ListadoSentencias lS = (ListadoSentencias)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int sentleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int sentright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Sentencia sent = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
	                    ...
	                    ScopeIF scope = scopeManager.getCurrentScope();
				   		...
				   		cb.addQuadruples(lS.getIntermediateCode());  //anadir el codigo de las sentencias ya generadas
				   		cb.addQuadruples(sent.getIntermediateCode());       //anadir el codigo de la nueva sentencia
