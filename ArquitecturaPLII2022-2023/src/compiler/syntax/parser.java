...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 12 12:15:43 GMT 2023
  */
						...
						if(sF.getParametros().size() == param.getListaExpr().size()){											
							for(int i = 0; i< sF.getParametros().size(); i++){					
								if(sF.getParametros().get(i).getType() != param.getListaExpr().get(i).getType()){
									semanticErrorManager.semanticFatalError("Error en linea " + id.getLine() + ": Error en tipo/orden de los parámetros en '" + id.getLexema() + "'");
								}
							}					
						}else{
							semanticErrorManager.semanticFatalError("Error en linea " + id.getLine() + ": Error en el número de parámetros en '" + id.getLexema() + "'");
						}
