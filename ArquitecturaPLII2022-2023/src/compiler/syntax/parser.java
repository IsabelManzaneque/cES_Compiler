...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Mar 04 09:28:30 GMT 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Object aV = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
      		...
      		Token token = (Token)aV;
      		RESULT = token.getLexema();
		...
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
							...
							// comprobar si ref existe en el ambito
							String refName = (String)r;
							if(!scopeManager.containsSymbol(refName)){
								semanticErrorManager.semanticFatalError("No existe el simbolo " + refName );							
							}
							...
							if(!(exp.getType() instanceof TypeSimpleEntero)){
								semanticErrorManager.semanticFatalError("Incompatibilidad de tipos en linea " + a.getLine());
							}
							
							// comprobar que ref no es una constante
							if(symbol instanceof SymbolConstant){
								semanticErrorManager.semanticFatalError("No se puede modificar el valor de la constante " + refName );
							}
