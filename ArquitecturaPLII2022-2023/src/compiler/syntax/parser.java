...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Apr 18 08:36:36 BST 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Sentencia sent = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
							...
							cb.addQuadruple("BRF1",e.getTemporal(),labelFinWhile);  //si temp es 0, saltar a etiqueta finWhile (cambiar por BRF para while clasico)
		...
		Sentencia sSi = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					cb.addQuadruples(e.getIntermediateCode());     //anadir codigo de la expresion
					cb.addQuadruple("BRF1",tempExp,labelFinSi);    //si tempExp es 0, saltar a etiqueta sino (cambiar por BRF para si clasico)
		...
		Sentencia sSino = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					cb.addQuadruples(e.getIntermediateCode());     
					cb.addQuadruple("BRF1",tempExp,labelSino);     //si tempExp es 0, saltar a etiqueta sino (cambiar por BRF para si clasico)
					cb.addQuadruples(sSi.getIntermediateCode());   //anadir codigo sentencias parte si					
					cb.addQuadruple("BR",labelFinSi);              //salto a etiqueta finSi
