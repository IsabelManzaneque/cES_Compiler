...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Apr 06 22:34:36 BST 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		AccesoVector aV = (AccesoVector)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
			...
			ref.setTemporal(aV.getTemporal());      // el temp de aV es MVP 
...
//				ref.setVar(var);
			...
			ref.setTemporal(temp);                // el temp es MVA
			ref.setIntermediateCode(cb.create());			
			RESULT = ref;
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
					...
					Variable var = new Variable((SymbolVariable)symbol);
                 	...
                 	cb.addQuadruple("MVA", tempBase, var);                       // obtiene la base del array             	              	
                 	cb.addQuadruple("SUB", tempSub, tempBase, e.getTemporal());  // calcula la direccion restando a la base el offset y poniendo el resultado en temp
                   // cb.addQuadruple("MVA",temp,tempSub);                       // pone un puntero a tempSub en temp  
                	
                 	aV.setIntermediateCode(cb.create());
                 	aV.setTemporal(tempSub);                                   // propaga temp
                 	RESULT = aV;
		...
		AccesoVector aV = (AccesoVector)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				cb.addQuadruple("MV",tempAux,temp);
