...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Mar 04 18:13:04 GMT 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		LlamadaFuncion fun = (LlamadaFuncion)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
				...
				SymbolFunction sF = (SymbolFunction) symbolFun;
				
				if(sF.getParametros().size() == fun.getListaExpr().size()){
									
					for(int i = 0; i< sF.getParametros().size(); i++){					
						if(sF.getParametros().get(i).getType() != fun.getListaExpr().get(i).getType()){
							semanticErrorManager.semanticFatalError("Error en el tipo de los par�metros en la llamada a " + fun.getName());
						}
					}					
				}else{
					semanticErrorManager.semanticFatalError("Error en el n�mero de par�metros en la llamada a " + fun.getName());
				}				
