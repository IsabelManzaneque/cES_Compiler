...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Feb 26 15:53:53 GMT 2023
  */
      ...
      switch (CUP$parser$act_num)
		...
		Object sP = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
				...
				for(Parametro param : listaParam.getListaParam()){							
					...
					System.out.println("Generando parametro: " + paramName);
		...
		ListadoIDs listaId = (ListadoIDs)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
							...
							// Obtenemos actual y la tabla de simbolos 
							ScopeIF scope = scopeManager.getCurrentScope();
							SymbolTableIF tablaSimbolos = scope.getSymbolTable();
							TypeTableIF tablaTipos = scope.getTypeTable();
							String type = iden.getLexema();
							...
							for(Id id : listaId.getListaIds()){
								...
								if(tablaSimbolos.containsSymbol(idName)){
									...
									// Introducimos en la tabla de simbolos la variable 
									
									System.out.println("Generando variable: " + idName);
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                ...
                //Buscamos la constante en el ambito y si existe tomamos su valor
		...
		Object tt = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
						...
						// Obtenemos el ambito donde nos encontramos y la tabla de simbolos 
						ScopeIF scope = scopeManager.getCurrentScope();
						SymbolTableIF tablaSimbolos = scope.getSymbolTable();
						String name = id.getLexema();
							
						// Comprobamos que el tipo no este ya declarado en la tabla de tipos de ningun ambito
						if(scopeManager.containsType(name)){
							semanticErrorManager.semanticFatalError("Tipo " + name + " ya declarado");			
												
						}else{																												
							// Introducimos en la tabla de tipos el nuevo tipo								
							System.out.println("Generando tipo: " + name);						
							TypeTableIF tablaTipos = scope.getTypeTable();							
		...
		Token value = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
							...
							if(tablaSimbolos.containsSymbol(name)){
								...
								System.out.println("Generando constante: " + name);
          ...
          case 3: // NT$1 ::= 
            {
              Axiom RESULT =null;
				...
				// Obtenemos la tabla de tipos y la de simbolos 
				// en cada scope debemos tener una de cada
				SymbolTableIF symbolTable = scope.getSymbolTable();
				TypeTableIF typeTable = scope.getTypeTable();	
				
				// Introduccion de tipos primitivos en la tabla de tipos
