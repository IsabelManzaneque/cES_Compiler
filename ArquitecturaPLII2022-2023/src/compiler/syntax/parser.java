...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 12 15:03:08 GMT 2023
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		ListadoIDs listaId = (ListadoIDs)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
							...
							for(Id id : listaId.getListaIds()){
								...
								if(!scopeManager.containsType(type)){
									semanticErrorManager.semanticFatalError("Tipo '" + type + "' no declarado");
								}	
		...
		SeccionFunciones sF = (SeccionFunciones)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
        	...
        	sC.getListaConstantes().forEach((n) -> System.out.println(n));
